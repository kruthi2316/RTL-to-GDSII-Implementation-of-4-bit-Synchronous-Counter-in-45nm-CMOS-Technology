...
#  Generated on:      Sun Aug 10 18:29:18 2025
#  Design:            counter
#  Command:           write_db counter/Innovus_new/counter_10_8
###############################################################
...
set_preference attribute_summary_rc_corner "cap_table_file name obj_type post_route_cap post_route_clock_cap post_route_clock_res post_route_cross_cap post_route_res pre_route_cap pre_route_clock_cap pre_route_clock_res pre_route_res qrc_tech_file temperature via_variation_file"
...
set_preference attribute_summary_via_def "bottom_layer bottom_rects bottom_rects_mask cut_class cut_columns cut_layer cut_rects cut_rects_mask cut_rows from_design from_lib is_default is_non_default name obj_type resistance top_layer top_rects top_rects_mask"
...
set_preference attribute_summary_route_type "bottom_mask_layer_num bottom_one_side_layer_num bottom_preferred_layer driver_use_multi_cut_via em_ndr_dist em_ndr_rule input_stack_via_rule is_table mask min_stack_layer name obj_type output_stack_via_rule route_effort route_rule shield_net shield_side stack_distance top_mask_layer_num top_one_side_layer_num top_preferred_layer"
...
set_preference attribute_summary_special_wire "area begin_extension end_extension has_trim_metal layer mask net obj_type path polygon rect shape shield_net status trim_metal_color trim_metal_rect type user_class width"
...
set_preference attribute_summary_sdp "bbox flip hier_name insts is_placed is_top justify_by local_list location name obj_type orient parent pin_alignment pin_names space type"
...
set_preference attribute_summary_gui_polygon "gui_layer_name obj_type pixel_width pts"
...
set_preference attribute_summary_gui_line "arrow gui_layer_name obj_type pixel_width pts"
...
set_preference attribute_summary_hpin "base_name constant depth direction dont_touch dont_touch_effective dont_touch_sources escaped_name hinst hnet hport is_tie_high is_tie_low location name net obj_type place_status side width"
