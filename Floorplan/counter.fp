...
#  Generated on:      Sun Aug 10 22:43:14 2025
#  Design:            counter
#  Command:           saveFPlan counter/Innovus_new/counter.fp
###############################################################

Version: 8

Head Box: 0.0000 0.0000 18.6200 18.2400
IO Box: 0.0000 0.0000 18.6200 18.2400
Core Box: 4.1800 4.1800 14.4400 14.0600
UseStdUtil: false
...
##############################################################################
DefRow: CORE_ROW_0 CoreSite 4.1800 4.1800 FS 27 1 0.3800 0.0000
DefRow: CORE_ROW_1 CoreSite 4.1800 6.6500 N 27 1 0.3800 0.0000
DefRow: CORE_ROW_2 CoreSite 4.1800 9.1200 FS 27 1 0.3800 0.0000
DefRow: CORE_ROW_3 CoreSite 4.1800 11.5900 N 27 1 0.3800 0.0000

############################################################################################
#  Track: dir start number space layer_num layer1 [firstColor] [isSameColor] [width] [rule]#
############################################################################################
Track: Y 1.8050 10 1.7100 1 10
Track: X 1.7750 11 1.6800 1 10
Track: X 0.9350 22 0.8400 1 9
Track: Y 1.8050 10 1.7100 1 9
Track: Y 1.0450 19 0.9500 1 8
Track: X 0.9350 22 0.8400 1 8
Track: X 0.3750 66 0.2800 1 7
Track: Y 1.0450 19 0.9500 1 7
Track: Y 0.3800 63 0.2850 1 6
Track: X 0.3750 66 0.2800 1 6
Track: X 0.3750 66 0.2800 1 5
Track: Y 0.3800 63 0.2850 1 5
Track: Y 0.0950 96 0.1900 1 4
Track: X 0.3750 66 0.2800 1 4
Track: X 0.0950 98 0.1900 1 3
Track: Y 0.0950 96 0.1900 1 3
Track: Y 0.0950 96 0.1900 1 2
Track: X 0.0950 98 0.1900 1 2
Track: X 0.0950 98 0.1900 1 1
Track: Y 0.0950 96 0.1900 1 1

######################################################
#  GCellGrid: dir start number space                 #
######################################################
GCellGrid: X 17.1950 2 1.4250
GCellGrid: X 0.0950 10 1.9000
GCellGrid: X 0.0000 2 0.0950
GCellGrid: Y 17.1950 2 1.0450
GCellGrid: Y 0.0950 10 1.9000
...
<HierarchicalPartitions>
    ...
    <Partition name="counter" hinst="" coreToLeft=0.0000 coreToRight=0.0000 coreToTop=0.0000 coreToBottom=0.0000 pinSpacingNorth=-1 pinSpacingWest=-1 pinSpacingSouth=-1 pinSpacingEast=-1 blockedLayers=0x3ff orient=R0>
...
<IOPins>
  <Pin name="clk" status="placed" >
    <Port>
      <Pref x=0.0000 y=8.4550 side=W width=0.0700 depth=0.0700 orientation=R270 />
      <Layer id=3 >
        <Box llx=0.0000 lly=8.4200 urx=0.0700 ury=8.4900 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="rst" status="placed" >
    <Port>
      <Pref x=9.9750 y=18.2400 side=N width=0.0700 depth=0.0700 orientation=R180 />
      <Layer id=2 >
        <Box llx=9.9400 lly=18.1700 urx=10.0100 ury=18.2400 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="out[3]" status="placed" >
    <Port>
      <Pref x=9.9750 y=0.0000 side=S width=0.0700 depth=0.0700 />
      <Layer id=2 >
        <Box llx=9.9400 lly=0.0000 urx=10.0100 ury=0.0700 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="out[2]" status="placed" >
    <Port>
      <Pref x=9.5950 y=0.0000 side=S width=0.0700 depth=0.0700 />
      <Layer id=2 >
        <Box llx=9.5600 lly=0.0000 urx=9.6300 ury=0.0700 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="out[1]" status="placed" >
    <Port>
      <Pref x=8.2650 y=18.2400 side=N width=0.0700 depth=0.0700 orientation=R180 />
      <Layer id=2 >
        <Box llx=8.2300 lly=18.1700 urx=8.3000 ury=18.2400 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="out[0]" status="placed" >
    <Port>
      <Pref x=7.8850 y=18.2400 side=N width=0.0700 depth=0.0700 orientation=R180 />
      <Layer id=2 >
        <Box llx=7.8500 lly=18.1700 urx=7.9200 ury=18.2400 />
      </Layer>
    </Port>
  </Pin>
</IOPins>
